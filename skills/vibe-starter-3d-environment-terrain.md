...
description: Core document on procedurally generating terrain (ground, land) and controlling its appearance and material using `vibe-starter-3d-environment` in a 3D project.
